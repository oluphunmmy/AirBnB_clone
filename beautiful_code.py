...
class Robot:
    """This is the representation of a robot with a name"""
    ...
    def __init__(self, name):
        """This module intializes the data"""
    ...
    def say_hi(self):
        """This displays greeting by the robot"""

        print("Greating, my master call me {}".format(self.name))

    @classmethod
    def how_many(cls):
        """This module prints the currrent population"""
